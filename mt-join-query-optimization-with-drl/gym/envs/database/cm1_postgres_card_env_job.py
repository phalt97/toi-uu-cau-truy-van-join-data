...
class CM1PostgresCardJob(gym.Env):
  ...
  def __init__(self):
    ...
    self.sql_query = list(open('/home/pha/mt-join-queryoptimization-with-drl/agents/queries/crossval/job_queries_simple_crossval_7400_3_test.txt'))
  ...
  def reset(self):
    ...
    sql_query = random.choice(list(open('/home/pha/mt-join-queryoptimization-with-drl/agents/queries/crossval/job_queries_simple_crossval_7400_0_train.txt'))).replace(";", "")
