...
class CM1PostgresCardJob2(gym.Env):
  ...
  def __init__(self):
    ...
    self.sql_query = list(open('/home/pha/mt-join-queryoptimization-with-drl/agents/queries/crossval_sens/job_queries_simple_crossval_2_test.txt'))
  ...
  def reset(self):
    ...
    #sql_query = random.choice(list(open('/home/pha/mt-join-queryoptimization-with-drl/agents/queries/crossval_sens/job_queries_simple_crossval_2_train.txt'))).replace(";", "")
