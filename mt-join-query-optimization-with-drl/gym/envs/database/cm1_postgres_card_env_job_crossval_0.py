...
class CM1PostgresCardJob0(gym.Env):
  ...
  def __init__(self):
    ...
    #self.sql_query = list(open('/home/pha/mt-join-queryoptimization-with-drl/agents/queries/job_queries_simple_test_7400.txt'))
    #self.sql_query = list(open('/home/pha/mt-join-queryoptimization-with-drl/agents/queries/job_queries_simple_rejoin_test.txt'))
    self.sql_query = list(open('/home/pha/mt-join-query-optimization-with-drl/agents/queries/crossval_sens/job_queries_simple_crossval_0_test.txt'))
    self.sql_query_num = 0


    # try:"dbname=gps_heatmap user=postgres host=localhost password=1234"
    #conn = psycopg2.connect("dbname=imdbload user=postgres host=localhost password=postgres")
  ...
  def reset(self):
    ...
    #sql_query = random.choice(list(open('/home/pha/mt-join-queryoptimization-with-drl/agents/queries/job_queries_simple_train_7400.txt'))).replace(";","")
    #sql_query = random.choice(list(open('/home/pha/mt-join-queryoptimization-with-drl/agents/queries/job_queries_simple_rejoin_train.txt'))).replace(";", "")
    #sql_query = random.choice(list(open('/home/pha/mt-join-queryoptimization-with-drl/agents/queries/crossval/job_queries_simple_crossval_7400_0_train_sort_a.txt'))).replace(";", "")
    #sql_query = random.choice(list(open('/home/pha/mt-join-queryoptimization-with-drl/agents/queries/crossval_sens/job_queries_simple_crossval_0_train.txt'))).replace(";", "")
