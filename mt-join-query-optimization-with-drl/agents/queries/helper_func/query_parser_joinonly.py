...
f = open("/home/pha/mt-join-queryoptimization-with-drl/agents/queries/job_queries_label.txt", "r")
w = open("/home/pha/mt-join-queryoptimization-with-drl/agents/queries/job_queries_simple_labled.txt", "w")
qselect="SELECT * "
for x in f:
  y=x.split('WHERE')
  qwhere = "WHERE"
